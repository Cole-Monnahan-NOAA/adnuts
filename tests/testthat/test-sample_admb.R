...
##                       control=list(metric='mle'), extra.args=' -refresh 0')
...
##                       seeds=rep(123,chains), init=inits.fn, cores=1,
##                       control=list(metric=diag(2)), extra.args=' -refresh 0'))
...
##                       seeds=rep(123,chains), init=inits.fn, cores=1,
##                       control=list(metric='unit'), extra.args=' -refresh 0')
