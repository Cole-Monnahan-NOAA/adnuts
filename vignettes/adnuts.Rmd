...
([@monnahan2018]) and '[SparseNUTS](https://github.com/noaa-afsc/SparseNUTS)' has replaced this functionality and users should exclusively use one of those packages. 
