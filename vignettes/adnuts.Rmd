...
correlations, but comes at a higher computation cost. Typically a diagonal
matrix is best and thus is default in both Stan and `adnuts`.
...
presented in [cite Hoffman]. However it also uses a similar mass matrix
...
manual [cite Stan] for more details. The step size is adapted during all
