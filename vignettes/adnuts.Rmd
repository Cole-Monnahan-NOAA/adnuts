...
`adnuts` main purpose is to provide a wrapper for performing Bayesian
...
even though ADMB found an MLE and successfully inverted the Hessian
...
allowed to create one-sided constraints, as with variance parameters. Note
